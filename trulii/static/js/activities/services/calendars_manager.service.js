(function () {
  ...
  CalendarsManager.$inject = ['$http','$q','$filter','Calendar'];

  function CalendarsManager($http,$q,$filter,Calendar) {  
    ...
    var CalendarsManager = {
        ...
        loadCalendars: function(activity_id) {
            ...
            return $http.get('/api/activities/'+this.activity_id+'/calendars/')
                .then(function(response){
